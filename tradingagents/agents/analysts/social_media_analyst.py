...
from tradingagents.agents.utils.news_data_tools import get_finnish_news
...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            ...
            "If either tool returns no results, base your assessment on broader Finnish market context."
        )
